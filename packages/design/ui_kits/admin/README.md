...
- `cash.html` — **Cash & settlements**: ⚠ shows the retired weekly 15%-commission settlement model. The live model is a prepaid wallet, per-delivery deduction, 0%→10% (`packages/design/RIDER-ONE-APP-PLAN.md` decision 1); treat this page as layout reference only until it's redesigned.
