...
| LC-D03 | Mark-ready / pickup-code reveal / cash-debt settlement fired as bare `void promise`, no `.catch` — fail silently at the counter. | `apps/merchant/app/components/queue/QueueBoard.tsx:128` | HIGH | OPEN → LC-D |
