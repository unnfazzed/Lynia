...
| 7 | `apps/api/src/tracking/tracking.gateway.ts` | grew to 828 lines (was 784) | mixes socket handlers/heartbeat/emit-coalescing over shared mutable state | SCOPED — RF-05 design pass done (`docs/RF-05-WS-GATEWAY-STATE.md`, roadmap 3.6); 3 sequenced PRs planned, none landed yet |
