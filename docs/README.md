...
| [`HOSTING-COST-COMPARISON.md`](./HOSTING-COST-COMPARISON.md) | 🟢 Living (analysis) | What the GCP stack actually costs (~$150–230/mo list, vs the ~$95–110 in `ENG-REVIEW`), GCP vs Azure vs AWS priced like-for-like in a Johannesburg region, the startup-credit ladders, the startup-friendly field filtered by "has an African region", and an honest read of how far D7 portability actually reaches. |
