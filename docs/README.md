...
| [`HOSTING-COST-COMPARISON.md`](./HOSTING-COST-COMPARISON.md) | 🟢 Living (analysis) | What the GCP stack actually costs — **measured from the billing console** ($47.53/mo average to date, trending to ~$105/mo; Memorystore is the largest service, ahead of Cloud SQL) — plus GCP vs Azure vs AWS priced like-for-like in a Johannesburg region, the startup-credit ladders, the startup-friendly field filtered by "has an African region", and an honest read of how far D7 portability actually reaches. |
