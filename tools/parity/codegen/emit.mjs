...
function assembleFile(spec, body) {
  ...
  const NON_BARREL = { ComposeMap: "/ComposeMap", ActiveSlot: "/ComposeMap", BottomSheet: "/BottomSheet", PickedPoint: "/MapPicker", JobCard: "/rider/JobCard", TypeTag: "/rider/TypeTag", CashStrip: "/rider/CashStrip" };
