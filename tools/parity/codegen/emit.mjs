...
function assembleFile(spec, body) {
  ...
  const uiPrims = ["AppBar", "Screen", "Field", "Card", "Icon", "Button", "StatusPill", "EmptyState", "Stepper", "Skeleton", "Money", "PriceMath", "Banner", "CoverPhoto", "MenuRow", "EtaLine", "ShopLogo", "FoodThumb", "Heading", "Sub", "Label", "SystemState", "BrandLockup", "DoveMark", "Wordmark", "ComposeMap", "BottomSheet", "JobCard", "TypeTag"].filter((n) => new RegExp(`<${n}[\\s/>]`).test(body));
  ...
  const NON_BARREL = { ComposeMap: "/ComposeMap", ActiveSlot: "/ComposeMap", BottomSheet: "/BottomSheet", PickedPoint: "/MapPicker", JobCard: "/rider/JobCard", TypeTag: "/rider/TypeTag" };
