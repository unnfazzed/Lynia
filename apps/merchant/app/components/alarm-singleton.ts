...
// page's "Sign in & start the alarm" gesture and the authenticated shell's mute toggle/test-ring must
// share the same unlocked context, not each create their own.
