...
// The no-bid-expiry supply check is best-effort; an empty nearby list keeps it off the geo path.
...
const matching = new MatchingService(prisma, tokens, noopNotifications, new MetricsService(), noopGateway, noopTracking);
