...
import { Tappable, Icon, Button, Heading, Sub, BrandLockup, type IconName } from "../src/ui";
...
export function RoleSelectView({
  ...
  return <View style={{
    ...
    minHeight: "100%"
      ...
      <Tappable onPress={onSelectCustomer} accessibilityRole="radio"><Opt icon="shopping-bag" title="Use LyniaGo" desc="Order food, send parcels, more services soon." selected={customerSelected} /></Tappable>
